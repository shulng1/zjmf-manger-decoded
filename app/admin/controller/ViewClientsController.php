...
class ViewClientsController extends ViewAdminBaseController
{
    ...
    public function clients(\think\Request $request)
    {
        ...
        $result["tip"] =
            "系统内所有客户信息，点击姓名可查看更多详细信息并对客户进行管理。<a href='https://www.idcsmart.com/wiki_list/401.html' target='_blank'>帮助文档</a>";
        $result["btnText"] = "添加客服";
    ...
    public function clientsauthentication(\think\Request $request)
    {
        ...
        $result["tip"] =
            "客户在进行实名认证时提交的信息记录，可在此下载证件及人工审核。<a href='https://www.idcsmart.com/wiki_list/401.html' target='_blank'>帮助文档</a>";
        $result["page"] = $param["page"] ? $param["page"] : 1;
    ...
    public function salesstatistics(\think\Request $request)
    {
        ...
        $result["tip"] =
            "有效查看销售人员的业绩。<a href=\"https://www.idcsmart.com/wiki_list/398.html\" target=\"_blank\">帮助文档</a>";
        $result["page"] = $param["page"] ? $param["page"] : 1;
    ...
    public function affiliates(\think\Request $request)
    {
        ...
        $result["seachList"] = [
            ["type" => "text", "label" => "客户名", "name" => "username", "content" => ""],
            ["type" => "text", "label" => "可提现佣金", "name" => "balance", "content" => ""],
            ["type" => "text", "label" => "访问量", "name" => "visitors", "content" => ""],
            ["type" => "text", "label" => "已提现佣金", "name" => "withdrawn", "content" => ""],
            ["type" => "text", "label" => "注册数量", "name" => "registcount", "content" => ""],
        ];
        $result["page"] = $param["page"] ? $param["page"] : 1;
    ...
    public function massmailsms(\think\Request $request)
    {
        $param = $request->param();
        $result["tip"] =
            "根据不同客户的各种状态、销售、语言、国家及注册时长进行选择推送消息。<a href='https://bbs.idcsmart.com/forum.php?mod=viewthread&tid=67&extra=page%3D1%26filter%3Dtypeid%26typeid%3D7' target='_blank'>帮助文档</a>";
        $result["page"] = $param["page"] ? $param["page"] : 1;
    ...
    public function configclientgroups(\think\Request $request)
    {
        ...
        $result["navTabs"] = [
            ["label" => "客户分组", "name" => "client"],
            ["label" => "商品分组", "name" => "goods"],
            ["label" => "折扣设置", "name" => "discount"],
        ];
        $result["tip"] =
            "系统内所有客户信息，点击姓名可查看更多详细信息并对客户进行管理。<a href='https://www.idcsmart.com/wiki_list/400.html' target='_blank'>帮助文档</a>";
    ...
    public function configauthentication(\think\Request $request)
    {
        $param = $request->param();
        $result["tip"] =
            "系统内所有客户信息，点击姓名可查看更多详细信息并对客户进行管理。<a href='https://bbs.idcsmart.com/forum.php?mod=viewthread&tid=67&extra=page%3D1%26filter%3Dtypeid%26typeid%3D7' target='_blank'>帮助文档</a>";
    ...
    public function configaffiliates(\think\Request $request)
    {
        $param = $request->param();
        $result["tip"] =
            "推荐提成相关设置，用户激活推介计划后，获取推荐链接，访问链接会生成cookie信息。注册时cookie有效则绑定推荐关系，推荐人将会获得佣金奖励。<a href='https://www.idcsmart.com/wiki_list/359.html'>查看帮助文档</a>";
    ...
    public function clientsinvoices(\think\Request $request)
    {
        ...
        $result["btnText"] = "添加账单";
        $result["seachList"] = [
            ["type" => "date", "label" => "账单生成日", "name" => "create_time", "content" => ""],
            ["type" => "date", "label" => "账单逾期日", "name" => "due_time", "content" => ""],
            ["type" => "select", "label" => "付款方式", "name" => "payment", "content" => "", "list" => $gateway],
            ["type" => "date", "label" => "账单支付日", "name" => "paid_time", "content" => ""],
            ["type" => "select", "label" => "付款状态", "name" => "status", "content" => "", "list" => $status],
            ["type" => "text", "label" => "总计从", "name" => "subtotal_small", "content" => ""],
            ["type" => "text", "label" => "至", "name" => "subtotal_big", "content" => ""],
        ];
        $result["modalTitle"] = $result["btnText"];
        $result["page"] = $param["page"] ? $param["page"] : 1;
        $result["total"] = 0;
    ...
    public function clientssupporttickets(\think\Request $request)
    {
        ...
        $result["pageSize"] = $this->ajaxPages(
    ...
    public function clientsnoticelog(\think\Request $request)
    {
        ...
        $result["navTabs"] = [
            ["label" => "短信日志", "name" => "SMS"],
            ["label" => "邮件日志", "name" => "email"],
            ["label" => "站内信日志", "name" => "station"],
        ];
