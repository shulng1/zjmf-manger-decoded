...
class ConfigCertifiController extends AdminBaseController
{
    ...
    public function setting()
    {
        ...
        $data["certifi_business_author_path_url"] = $data["certifi_business_author_path"]
            ? config("author_attachments_url") . $data["certifi_business_author_path"]
            : "";
        return jsonrule([
            "status" => 200,
    ...
    public function settingPost()
    {
        ...
        if (
            $param["certifi_business_open"] &&
            $param["certifi_business_is_author"] &&
            empty($param["certifi_business_author_path"])
        ) {
    ...
    public function initialize()
    {
        ...
        $this->alipay_biz_code = [
            ["name" => "快捷认证（无需识别）", "value" => "SMART_FACE"],
