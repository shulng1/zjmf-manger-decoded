...
class CreditController extends AdminBaseController
{
    ...
    public function index()
    {
        ...
        $en = [
            ...
            "Credit Applied to Renew Invoice",
            "Add Funds Invoice",
            "Credit Removed from Invoice",
            "Credit from Refund of Invoice",
            "Upgrade/Downgrade Credit",
            "Recharge",
            "Promotion program activity reward",
        ...
        $user = \think\Db::name("clients")
            ->alias("a")
            ->field("username,credit,b.prefix,b.suffix")
