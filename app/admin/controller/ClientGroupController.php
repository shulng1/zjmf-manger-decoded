...
class ClientGroupController extends AdminBaseController
{
    ...
    public function update($id)
    {
        ...
        $rule = [
            "group_name" => "require",
            "group_colour" => "require",
            "discount_percent" => "require|number",
            "susptermexempt" => "require|in:0,1",
            "separateinvoices" => "require|in:0,1",
        ];
        $msg = [
            "group_name.require" => "客户组名称不能为空",
            "group_colour.require" => "组颜色不能为空",
            "discount_percent.require" => "折扣百分比不能为空",
            "susptermexempt.require" => "暂停/删除豁免权不能为空",
            "separateinvoices.require" => "拆分服务账单不能为空",
        ];
