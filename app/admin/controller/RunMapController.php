...
{
    protected $CRON_TYPE_DATE = [
        ["type" => 1, "name" => "自动暂停", "is_show" => 1, "show_fail" => 1, "keywords" => "产品到期暂停"],
        ["type" => 2, "name" => "未实名暂停", "is_show" => 1, "show_fail" => 1, "keywords" => "未实名客户产品暂停"],
        ["type" => 3, "name" => "信用额产品暂停", "is_show" => 1, "show_fail" => 1, "keywords" => "信用额账单未支付"],
        ["type" => 4, "name" => "自动删除", "is_show" => 1, "show_fail" => 1, "keywords" => "产品到期删除"],
        ["type" => 5, "name" => "停用产品删除", "is_show" => 0, "show_fail" => 1, "keywords" => "停用产品删除"],
        ["type" => 6, "name" => "删除订单", "is_show" => 1, "show_fail" => 0, "keywords" => ""],
        ["type" => 7, "name" => "DCIM流量重置", "is_show" => 1, "show_fail" => 1, "keywords" => "DCIM流量"],
        ["type" => 8, "name" => "魔方云流量重置", "is_show" => 1, "show_fail" => 1, "keywords" => "魔方云流量"],
        ["type" => 9, "name" => "关闭工单", "is_show" => 1, "show_fail" => 0, "keywords" => ""],
        ["type" => 10, "name" => "信用额账单提醒", "is_show" => 1, "show_fail" => 0, "keywords" => ""],
        ["type" => 11, "name" => "信用额还款提醒", "is_show" => 1, "show_fail" => 0, "keywords" => ""],
        ["type" => 12, "name" => "账单提醒", "is_show" => 1, "show_fail" => 0, "keywords" => ""],
        ["type" => 13, "name" => "生成账单", "is_show" => 1, "show_fail" => 0, "keywords" => ""],
    ];
    /**
     * @title 任务队列列表
    ...
    public function runMapList(\think\Request $request)
    {
        ...
        return jsonrule([
            ...
            "data" => ["count" => $res_data["count"], "list" => $res_data["list"]],
        ]);
    }
    /**
     * @title 失败队列任务进行重发
    ...
    public function repeatTask(\think\Request $request)
    {
        ...
        switch ($res_data["active_type"]) {
            ...
            case 5:
                ...
                break;
            case 6:
                $result = $host_logic->changePackage(
                    $active_type_param[0],
                    $active_type_param[1],
                    $active_type_param[2],
                    $active_type_param[3],
