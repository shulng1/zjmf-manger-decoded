...
class ViewSystemController extends ViewAdminBaseController
{
    ...
    public function addHelp(\think\Request $request)
    {
        ...
        $result["formList"] = [
            ...
            ["type" => "checkbox", "label" => "是否隐藏", "name" => "isShow", "content" => ""],
            ["type" => "date", "label" => "日期选择", "name" => "helpDate", "content" => ""],
            ["type" => "text", "label" => "标签", "name" => "helpLabel", "content" => "", "tip" => "请填写标签"],
            ["type" => "text", "label" => "描述", "name" => "description", "content" => "", "tip" => "请填写描述"],
            ["type" => "textarea", "label" => "文章内容", "name" => "content", "content" => ""],
        ];
        $result["success"] = "保存更改";
        $result["cancel"] = "取消更改";
        $data = $_GET;
    ...
    public function smstemplateindex(\think\Request $request)
    {
        ...
        $result["seachList"] = [
            ["type" => "text", "label" => "模板ID搜索", "name" => "template_id", "content" => ""],
            ["type" => "text", "label" => "模板标题搜索", "name" => "title", "content" => ""],
        ];
