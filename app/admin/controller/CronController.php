...
class CronController extends AdminBaseController
{
    ...
    public function saveCron()
    {
        $params = input("post.");
        $rule = [
            "cron_day_start_time" => "number|between:0,23",
            "cron_host_suspend_time" => "number",
            "cron_host_terminate_time" => "number",
            "cron_invoice_first_overdue_email" => "number",
            "cron_invoice_second_overdue_email" => "number",
            "cron_invoice_third_overdue_email" => "number",
            "cron_ticket_close_time" => "number",
            "cron_client_delete_time" => "number",
            "cron_other_client_update" => "in:0,1,2",
            "cron_host_terminate_high" => "in:0,1",
            "cron_host_terminate_time_hostingaccount" => "number",
            "cron_host_terminate_time_server" => "number",
            "cron_host_terminate_time_cloud" => "number",
            "cron_host_terminate_time_dcimcloud" => "number",
            "cron_host_terminate_time_dcim" => "number",
            "cron_host_terminate_time_cdn" => "number",
            "cron_host_terminate_time_other" => "number",
            "cron_credit_limit_suspend_time" => "number",
            "cron_credit_limit_invoice_unpaid_email" => "number",
            "cron_credit_limit_invoice_first_overdue_email" => "number",
            "cron_credit_limit_invoice_second_overdue_email" => "number",
            "cron_credit_limit_invoice_third_overdue_email" => "number",
            "cron_order_unpaid_time_high" => "in:0,1",
            "cron_invoice_recharge_delete" => "in:0,1",
            "cron_invoice_recharge_delete_time" => "number",
        ];
        $msg = [
            "cron_day_start_time.number" => lang("FORMAT_ERROR"),
            "cron_day_start_time.between" => lang("FORMAT_ERROR"),
            "cron_host_suspend_time.number" => lang("FORMAT_ERROR"),
            "cron_host_terminate_time.number" => lang("FORMAT_ERROR"),
            "cron_invoice_first_overdue_email.number" => lang("FORMAT_ERROR"),
            "cron_invoice_second_overdue_email.number" => lang("FORMAT_ERROR"),
            "cron_invoice_third_overdue_email.number" => lang("FORMAT_ERROR"),
            "cron_ticket_close_time.number" => lang("FORMAT_ERROR"),
            "cron_client_delete_time.number" => lang("FORMAT_ERROR"),
            "cron_other_client_update.in" => lang("FORMAT_ERROR"),
            "cron_host_terminate_high.in" => lang("FORMAT_ERROR"),
            "cron_host_terminate_time_hostingaccount.number" => lang("FORMAT_ERROR"),
            "cron_host_terminate_time_server.number" => lang("FORMAT_ERROR"),
            "cron_host_terminate_time_cloud.number" => lang("FORMAT_ERROR"),
            "cron_host_terminate_time_dcimcloud.number" => lang("FORMAT_ERROR"),
            "cron_host_terminate_time_dcim.number" => lang("FORMAT_ERROR"),
            "cron_host_terminate_time_cdn.number" => lang("FORMAT_ERROR"),
            "cron_host_terminate_time_other.number" => lang("FORMAT_ERROR"),
            "cron_credit_limit_suspend_time.number" => lang("FORMAT_ERROR"),
            "cron_credit_limit_invoice_unpaid_email.number" => lang("FORMAT_ERROR"),
            "cron_credit_limit_invoice_first_overdue_email.number" => lang("FORMAT_ERROR"),
            "cron_credit_limit_invoice_second_overdue_email.number" => lang("FORMAT_ERROR"),
            "cron_credit_limit_invoice_third_overdue_email.number" => lang("FORMAT_ERROR"),
            "cron_order_unpaid_time_high.in" => lang("FORMAT_ERROR"),
            "cron_invoice_recharge_delete.in" => lang("FORMAT_ERROR"),
            "cron_invoice_recharge_delete_time.number" => lang("FORMAT_ERROR"),
        ];
