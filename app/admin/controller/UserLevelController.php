...
class UserLevelController extends GetUserController
{
    ...
    public function getList()
    {
        ...
        $list = \think\Db::name("clients_level_rule")
            ->field("id,level_name,expense,buy_num,login_times,last_login_times,renew_times,last_renew_times")
    ...
    public function postLevel()
    {
        ...
        $last_login_times = [
            "min" => intval($param["last_login_times_min"]),
            "max" => intval($param["last_login_times_max"]),
            "day" => intval($param["last_login_times_day"]),
        ];
        $renew_times = ["min" => intval($param["renew_times_min"]), "max" => intval($param["renew_times_max"])];
        $last_renew_times = [
            "min" => intval($param["last_renew_times_min"]),
            "max" => intval($param["last_renew_times_max"]),
            "day" => intval($param["last_renew_times_day"]),
        ];
        $insert = [
            "level_name" => $param["level_name"],
            "expense" => json_encode($expense),
            "buy_num" => json_encode($buy_num),
            "login_times" => json_encode($login_times),
            "last_login_times" => json_encode($last_login_times),
            "renew_times" => json_encode($renew_times),
            "last_renew_times" => json_encode($last_renew_times),
        ];
        if ($id) {
