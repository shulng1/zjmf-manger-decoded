...
class IndexController extends AdminBaseController
{
    ...
    public function initialize()
    {
        ...
        $app_lang = app_lang();
        $this->data2 = [
            ["name" => "Client", "value" => $app_lang["tablelist_client"]],
            ["name" => "Products", "value" => $app_lang["tablelist_products"]],
            ["name" => "Tickets", "value" => $app_lang["tablelist_tickets"]],
            ["name" => "Invoice", "value" => $app_lang["tablelist_invoice"]],
            ["name" => "Orders", "value" => $app_lang["tablelist_orders"]],
        ];
        $customfields = \think\Db::name("customfields")
            ...
            ->toArray();
        $this->data["Client"] = [
            ["name" => "cli.id", "value" => $app_lang["tablelist_client_id"], "type" => 0, "ab_name" => "ID"],
            [
                "name" => "cli.username",
                "value" => $app_lang["tablelist_client_username"],
                "type" => 1,
                "ab_name" => "username",
            ],
            ["name" => "cli.email", "value" => $app_lang["tablelist_client_email"], "type" => 1, "ab_name" => "email"],
            ["name" => "cli.qq", "value" => "qq", "type" => 1, "ab_name" => "qq"],
            [
                "name" => "cli.phonenumber",
                "value" => $app_lang["tablelist_client_phonenumber"],
                "type" => 1,
                "ab_name" => "phonenumber",
            ],
            [
                "name" => "cli.companyname",
                "value" => $app_lang["tablelist_client_companyname"],
                "type" => 1,
                "ab_name" => "companyname",
            ],
            [
                "name" => "cli.groupid",
                "value" => $app_lang["tablelist_client_group"],
                "type" => 0,
                "ab_name" => "groupid",
            ],
            [
                "name" => "cli.sale_id",
                "value" => $app_lang["tablelist_client_sale"],
                "type" => 0,
                "ab_name" => "sale_id",
            ],
        ];
        ...
        $this->data["Products"] = [
            ["name" => "h.id", "value" => $app_lang["tablelist_products_id"], "type" => 0, "ab_name" => "ID"],
            [
                "name" => "h.domainstatus",
                "value" => $app_lang["tablelist_products_domainstatus"],
                "type" => 0,
                "ab_name" => "status",
            ],
            ["name" => "p.id", "value" => $app_lang["tablelist_products_name"], "type" => 0, "ab_name" => "PID"],
            [
                "name" => "h.domain",
                "value" => $app_lang["tablelist_products_domain"],
                "type" => 1,
                "ab_name" => "domain",
            ],
            ["name" => "h.dedicatedip", "value" => "IP", "type" => 1, "ab_name" => "IP"],
            [
                "name" => "h.nextduedate",
                "value" => $app_lang["tablelist_products_nextduedate"],
                "type" => 0,
                "ab_name" => "nextduedate",
            ],
            [
            ...
            [
                "name" => "h.username",
                "value" => $app_lang["tablelist_products_username"],
                "type" => 1,
                "ab_name" => "husername",
            ],
            ["name" => "c.sale_id", "value" => $app_lang["tablelist_client_sale"], "type" => 2, "ab_name" => "saleID"],
            [
                "name" => "h.billingcycle",
                "value" => $app_lang["tablelist_products_billingcycle"],
                "type" => 2,
                "ab_name" => "cycle",
            ],
            ["name" => "p.type", "value" => $app_lang["tablelist_products_type"], "type" => 2, "ab_name" => "type"],
        ];
        $this->data["Tickets"] = [
            ["name" => "a.tid", "value" => $app_lang["tablelist_tickets_id"], "type" => 0, "ab_name" => "TID"],
            [
                "name" => "d.username",
                "value" => $app_lang["tablelist_client_username"],
                "type" => 1,
            ...
            ["name" => "a.title", "value" => $app_lang["tablelist_tickets_title"], "type" => 1, "ab_name" => "title"],
            [
                "name" => "a.status",
                "value" => $app_lang["tablelist_tickets_status"],
                "type" => 2,
                "ab_name" => "status",
            ],
            ["name" => "c.id", "value" => $app_lang["tablelist_tickets_cid"], "type" => 2, "ab_name" => "CID"],
        ];
        $this->data["Invoice"] = [
            ["name" => "i.id", "value" => $app_lang["tablelist_invoice_id"], "type" => 0, "ab_name" => "ID"],
            [
                "name" => "c.username",
                "value" => $app_lang["tablelist_client_username"],
                "type" => 1,
            ...
            [
                "name" => "i.subtotal",
                "value" => $app_lang["tablelist_invoice_subtotal"],
                "type" => 0,
                "ab_name" => "subtotal",
            ],
            [
                "name" => "i.paid_time",
                "value" => $app_lang["tablelist_invoice_paid_time"],
                "type" => 0,
                "ab_name" => "paidtime",
            ],
            [
                "name" => "i.status",
                "value" => $app_lang["tablelist_invoice_status"],
                "type" => 2,
                "ab_name" => "status",
            ],
            ["name" => "c.sale_id", "value" => $app_lang["tablelist_client_sale"], "type" => 2, "ab_name" => "saleID"],
            ["name" => "i.type", "value" => $app_lang["tablelist_invoice_type"], "type" => 2, "ab_name" => "type"],
        ];
        $this->data["Orders"] = [
            ["name" => "o.id", "value" => $app_lang["tablelist_orders_id"], "type" => 0, "ab_name" => "ID"],
            ["name" => "c.sale_id", "value" => $app_lang["tablelist_client_sale"], "type" => 2, "ab_name" => "saleID"],
            [
                "name" => "o.amount",
                "value" => $app_lang["tablelist_invoice_subtotal"],
            ...
            [
                "name" => "o.create_time",
                "value" => $app_lang["tablelist_orders_create_time"],
                "type" => 0,
                "ab_name" => "createtime",
            ],
        ];
    ...
    public function search()
    {
        ...
        $data = [];
        $data[] = [
            "Client" => ["name" => "用户", "list" => $this->getClients($value, "client")],
            "Products" => ["name" => "产品", "list" => $this->getProducts($value)],
            "Tickets" => ["name" => "工单", "list" => $this->getTickets($value)],
            "Invoice" => ["name" => "账单", "list" => $this->getInvoice($value)],
            "Customfields" => ["name" => "自定义字段", "list" => $this->getClients($value, "custom")],
        ];
    ...
    private function searchClients($value, $key, $flag = 0, $type = "client")
    {
        ...
        if ($type == "custom") {
            $datac = \think\Db::name("clients")
                ->field("c.id,c.id as url,c.email as values3,c.status,cf.fieldname as values1,cfv.value as values2")
                ->alias("c")
                ->leftJoin("customfieldsvalues cfv", "cfv.relid = c.id")
            ...
            $datac = \think\Db::name("clients")
                ->field("c.id,c.id as url,c.username as values1,c.companyname as values2,c.email as values3,c.status")
                ->alias("c")
                ->where(function (\think\db\Query $query) use ($param, $value) {
                    $certifi_uid = \think\Db::name("certifi_log")
                        ->where("certifi_name", "like", "%" . trim($value) . "%")
                        ->where("status", 1)
                        ->column("uid");
    ...
    private function searchCeriClients($value, $flag = 0)
    {
        if ($flag == 0) {
            $param = [
                ...
                "cl.company_name",
                "cl.idcard",
                "cl.company_organ_code",
                "cl.phone",
            ];
        } else {
            $param = $flag;
        }
        $datacl = \think\Db::name("clients")
            ->field("c.id,c.id as url,c.email as values1,c.username as values2,c.email as values3,c.status")
            ->alias("c")
            ->leftJoin("certifi_log cl", "cl.uid=c.id")
            ->where("cl.status=2")
            ->where(function (\think\db\Query $query) use ($param, $value) {
                foreach ($param as $v) {
                    $query->whereOr($v, "like", "%{$value}%");
    ...
    private function searchProducts($value, $key, $flag = 0)
    {
        ...
        $data = \think\Db::name("host")
            ...
            ->join("product_groups pg", "pg.id=p.gid")
            ->join("clients c", "c.id=h.uid")
            ->leftJoin("promo_code pc", "pc.id=h.promoid")
            ->field(
                "c.id,h.id as url,p.name as values1,h.domain as values2,h.domainstatus as status,c.username as values3",
            )
            ->where(function (\think\db\Query $query) use ($param, $value) {
                foreach ($param as $v) {
                    $query->whereOr($v, "like", "%{$value}%");
    ...
    private function searchOrders($value, $key, $flag = 0)
    {
        ...
        if ($flag == 0) {
            if (!empty($key)) {
                ...
                $param = [
                    ...
                    "h.subscriptionid",
                    "h.suspendreason",
                    "h.overideautosuspend",
                    "h.overidesuspenduntil",
                    "h.dedicatedip",
                    "h.assignedips",
                    "h.ns1",
                    "h.ns2",
        ...
        $data = \think\Db::name("orders")
            ->alias("o")
            ->join("host h", "o.id=h.orderid")
            ->join("products p", "p.id=h.productid")
            ->join("product_groups pg", "pg.id=p.gid")
            ->join("clients c", "c.id=o.uid")
            ->field("c.id,o.id as url,p.name as values1,h.dedicatedip as values2,o.status,c.username as values3")
            ->where(function (\think\db\Query $query) use ($param, $value) {
                foreach ($param as $v) {
                    $query->whereOr($v, "like", "%{$value}%");
                }
    ...
    private function searchInvoice($value, $key, $flag = 0)
    {
        ...
        $data = \think\Db::name("Invoices")
            ->alias("i")
            ->join("clients c", "c.id=i.uid")
            ->field("c.id,i.id as url,i.id as values2,c.username as values3,i.status")
            ->where(function (\think\db\Query $query) use ($param, $value) {
                foreach ($param as $v) {
                    $query->whereOr($v, "like", "%{$value}%");
                }
    ...
    private function searchTickets($value, $key, $flag = 0)
    {
        ...
        $data = \think\Db::name("Ticket")
            ->alias("t")
            ->join("ticket_department td", "td.id=t.dptid")
            ->join("clients c", "c.id=t.uid")
            ->field("c.id,t.id as url,t.tid as values2,t.status,t.title,c.username as values3")
            ->where(function (\think\db\Query $query) use ($param, $value) {
                foreach ($param as $v) {
                    $query->whereOr($v, "like", "%{$value}%");
                }
    ...
    private function searchClients_left($value, $key, $flag = 0, $page, $limit)
    {
        ...
        $total = \think\Db::name("clients")
            ->alias("cli")
            ->field(
                "cli.id,cli.id as url,cli.username,cli.sale_id,cg.group_colour,cli.companyname,cli.phonenumber,cli.email,cli.create_time,cli.qq,
            cc.status as company_status,cp.status as person_status,wu.id as wechat_id,cli.lastlogin,cli.status as client_status,u.user_nickname",
            )
        ...
        $list = \think\Db::name("clients")
            ...
            ->field(
                "LENGTH(substring_index(" .
                    ...
                    "',1)) as order1,LENGTH(" .
                    $key .
                    ") as order2,cli.id,cli.id as url,cli.username,cli.sale_id,cg.group_colour,cli.companyname,cli.phonenumber,cli.email,cli.create_time,cli.qq,
            cc.status as company_status,cp.status as person_status,wu.id as wechat_id,cli.lastlogin,cli.status as client_status,u.user_nickname",
            )
            ->leftJoin("certifi_company cc", "cc.auth_user_id = cli.id")
            ->leftJoin("certifi_person cp", "cp.auth_user_id = cli.id")
    ...
    private function searchClients_left_custom($page, $limit, $custom = [])
    {
        ...
        if (!empty($custom)) {
            $obj = $obj
                ...
                ->leftJoin("customfields cf", "cf.id = cfv.fieldid")
                ->where("cf.type", "client")
                ->where("cf.id", array_keys($custom)[0])
                ->where("cfv.value", "like", "%" . array_values($custom)[0] . "%");
        }
        $total = $obj->count();
        $list = $obj
            ->withAttr("url", function ($value, $data) {
    ...
    private function searchProducts_left($value, $key, $flag = 0, $page, $limit)
    {
        ...
        $count = \think\Db::name("host")
            ->field(
                "LENGTH(substring_index(" .
                    ...
                    "',1)) as order1,LENGTH(" .
                    $key .
                    ") as order2,h.id,h.id as url,h.domain,h.uid,h.dedicatedip,h.productid,h.billingcycle,h.domain,h.payment,h.nextduedate,h.assignedips,h.regdate,h.dedicatedip,h.amount,h.domainstatus,c.username,p.name as productname,c.currency,p.type,h.serverid,u.user_nickname",
            )
            ->alias("h")
            ->leftJoin("products p", "p.id=h.productid")
            ->leftJoin("clients c", "c.id=h.uid")
        ...
        foreach ($product_groups as $key => $val) {
            $groupid = $val["id"];
            $product_list[$i] = $val;
            $product_list[$i]["clild"] = \think\Db::name("products")
                ->field("id,name as productname")
                ->select()
                ->toArray();
            $i++;
        }
        ...
        $rows = \think\Db::name("orders")
            ...
            ->field(
                "LENGTH(substring_index(" .
                    ...
                    "',1)) as order1,LENGTH(" .
                    $key .
                    ") as order2,c.username,c.companyname,o.id,o.id as url,o.uid,c.sale_id,o.status,o.ordernum,i.status as i_status,i.subtotal as sub,i.credit,i.use_credit_limit,o.create_time,o.invoiceid,o.amount,o.amount as am,o.payment,cu.prefix,cu.suffix,u.user_nickname",
            )
    ...
    private function searchInvoice_left($value, $key, $flag = 0, $page, $limit)
    {
        ...
        $rows = \think\Db::name("invoices")
            ...
            ->field(
                "LENGTH(substring_index(" .
                    ...
                    "',1)) as order1,LENGTH(" .
                    $key .
                    ") as order2,c.username,i.id,i.id as url,i.uid,i.invoice_num,i.create_time,i.due_time,i.subtotal,i.subtotal as sub,i.total,cu.prefix,cu.suffix,i.status,i.payment,i.credit,i.type,i.use_credit_limit,c.sale_id,i.paid_time",
            )
        ...
        $count = \think\Db::name("invoices")
            ->alias("i")
            ->field(
                "c.username,i.id,i.id as url,i.uid,i.invoice_num,i.create_time,i.due_time,i.subtotal,i.subtotal as sub,i.total,cu.prefix,cu.suffix,i.status,i.payment,i.credit,i.type,c.sale_id",
            )
            ->leftjoin("clients c", "c.id=i.uid")
            ->leftJoin("currencies cu", "cu.id = c.currency")
            ->where(function (\think\db\Query $query) use ($param, $value) {
        ...
        $rows1 = \think\Db::name("invoices")
            ->alias("i")
            ->field(
                "c.username,i.id,i.uid,i.invoice_num,i.create_time,i.due_time,i.subtotal,cu.prefix,cu.suffix,i.status,i.payment,i.credit,i.type,i.paid_time",
            )
            ->leftjoin("clients c", "c.id=i.uid")
            ->leftJoin("currencies cu", "cu.id = c.currency")
            ->where(function (\think\db\Query $query) use ($param, $value) {
    ...
    private function searchTickets_left($value, $key, $flag = 0, $page, $limit)
    {
        ...
        $data = \think\Db::name("ticket")
            ...
            ->field(
                "LENGTH(substring_index(" .
                    ...
                    "',1)) as order1,LENGTH(" .
                    $key .
                    ") as order2,a.id,a.id as url,a.tid,a.uid,a.title,a.name,a.status,a.create_time,t.color as statusColor,t.title as status_title,a.last_reply_time,b.user_login flag_admin,c.name department_name,d.username user_name",
            )
            ->leftJoin("user b", "a.flag=b.id")
            ->leftJoin("ticket_department c", "a.dptid=c.id")
            ->leftJoin("clients d", "a.uid=d.id")
            ->leftJoin("ticket_status t", "a.status = t.id")
            ->where(function (\think\db\Query $query) use ($param, $value) {
                foreach ($param as $v) {
                    $query->where($v, "like", "%{$value}%");
                }
        ...
        $data = $data
            ...
            ->select()
            ->toArray();
        $count = \think\Db::name("ticket")
            ->alias("a")
            ->field(
                "a.id,a.id as url,a.tid,a.uid,a.title,a.name,a.status,a.create_time,t.color as statusColor,t.title as status_title,a.last_reply_time,b.user_login flag_admin,c.name department_name,d.username user_name",
            )
            ->leftJoin("user b", "a.flag=b.id")
            ->leftJoin("ticket_department c", "a.dptid=c.id")
            ->leftJoin("clients d", "a.uid=d.id")
        ...
        $rows = \think\Db::name("orders")
            ...
            ->field(
                "LENGTH(substring_index(" .
                    ...
                    "',1)) as order1,LENGTH(" .
                    $key .
                    ") as order2,o.id,c.sale_id,o.invoiceid,cu.prefix,cu.suffix,o.amount as am",
            )
            ->where($where)
            ->where(function (\think\db\Query $query) use ($param, $value) {
                foreach ($param as $v) {
        ...
        $row1 = \think\Db::name("orders")
            ...
            ->field(
                "LENGTH(substring_index(" .
                    ...
                    "',1)) as order1,LENGTH(" .
                    $key .
                    ") as order2,o.id,c.sale_id,o.invoiceid,cu.prefix,cu.suffix,o.amount",
            )
            ->where($where)
            ->where("o.delete_time", 0)
            ->where(function (\think\db\Query $query) use ($param, $value) {
    ...
    public function tableList()
    {
        ...
        $list = \think\Db::name("user")
            ->field("id as value,user_nickname as label")
            ->where("is_sale", 1)
            ->select()
            ->toArray();
        $data1["salelist"] = $list;
        ...
        $list = \think\Db::name("ticket_department")
            ->field("id as value,name as label")
            ->where("id", "in", $ids)
            ->select();
        ...
        if ($table == "Client") {
            ...
            if ($flag == 0) {
                ...
                return jsonrule([
                    ...
                    "price_total_page" => $data["price_total_page"],
                ]);
            } else {
    ...
    public function nameList()
    {
        ...
        if ($value == "Client") {
            $data[] = [
                ...
                "c.credit" => "余额",
                "c.ip" => "ip",
                "c.lastloginip" => "最近登陆ip",
                "cl.bank" => "银行",
                "cl.certifi_name" => "真实姓名",
                "cl.company_name" => "公司名字",
                "cl.idcard" => "身份证号",
                "cl.company_organ_code" => "营业执照",
            ];
            ...
            $data[] = [
                ...
                "p.description" => "产品描述",
                "h.domain" => "主机名",
                "h.firstpaymentamount" => "第一次支付价格",
                "h.amount" => "续费价格",
                "h.username" => "用户名",
                "h.notes" => "备注",
                "h.suspendreason" => "暂停原因",
                "h.dedicatedip" => "独立ip地址",
                "h.assignedips" => "分配的ip地址",
                "h.ns1" => "域名服务器1",
                "h.ns2" => "域名服务器2",
                "h.os" => "操作系统",
                "h.port" => "端口",
