...
class RuleMiddleController extends AdminBaseController
{
    ...
    public function addMenu()
    {
        ...
        return $this->tryCatch(function () use ($param) {
            $data = [
                "name" => $param["name"],
                "add_role" => $param["add_role"] ?? 1,
                "add_role_menu" => $param["add_role_menu"] ?: "",
                "cat_role" => $param["cat_role"] ?? 1,
                "cat_role_menu" => $param["cat_role_menu"] ?: "",
                "del_role" => $param["del_role"] ?? 1,
                "del_role_menu" => $param["del_role_menu"] ?: "",
                "edit_role" => $param["edit_role"] ?? 1,
                "edit_role_menu" => $param["edit_role_menu"] ?: "",
                "order" => 1,
                "pid" => 0,
            ];
