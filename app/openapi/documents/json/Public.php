...
return [
    ...
    "item" => [
        "secondVerify" => [
            "title" => "提交二次验证",
            "desc" =>
                "提交二次验证,在其它接口返回的数据中提示需要二次验证的，第一步，“获取验证码”接口，第二步，提交用户填的验证码到该接口",
        ...
        "code" => [
            ...
            "param" => [
                ...
                [
                    ...
                    "require" => "必填",
                    "max" => "-",
                    "desc" => "发送类型有：<br> phone 手机<br> email 邮箱<br> ",
                    "example" => "phone",
                ],
                [
                    "name" => "phone_code",
