...
return [
    "title" => "Server module类",
    "item" => [
        "module" => [
            "title" => "获取主机支持的server模块接口",
            "desc" => "该主机支持的server模块接口",
            ...
            "return" => [
                [
                    ...
                    "require" => "",
                    "max" => "-",
                    "desc" => "default  默认   <br/>custom  自定义   <br/>",
                    "example" => "",
                ],
                [
                    "name" => "function",
        ...
        "status" => [
            ...
            "param" => [
                [
                    ...
                    "max" => "-",
                    "desc" =>
                        "host 服务器电源状态  <br/>reinstall 获取重装,救援系统,重置密码进度（dcim类型主机才有）   <br/>",
                    "example" => "",
                ],
            ],
        ],
        ...
        "rescue" => [
            ...
            "param" => [
                [
                    ...
                    "require" => "必填",
                    "max" => "-",
                    "desc" => "救援系统ID,这里固定只有linux和windows。linux传1，windows传2",
                    "example" => "2",
                    "child" => [],
                ],
            ],
