...
class PublicController extends \cmf\controller\HomeBaseController
{
    ...
    public function code()
    {
        ...
        $data = $this->request->param();
        $action = [
            "login_phone_code" => intval(configuration("allow_login_code_captcha")),
            "register_phone" => intval(configuration("allow_register_phone_captcha")),
            "register_email" => intval(configuration("allow_register_email_captcha")),
            "pwreset_phone" => intval(configuration("allow_phone_forgetpwd_captcha")),
            "pwreset_email" => intval(configuration("allow_email_forgetpwd_captcha")),
            "second_phone" => 0,
            "second_email" => 0,
            "bind_phone" => intval(configuration("allow_phone_bind_captcha")),
            "bind_email" => intval(configuration("allow_email_bind_captcha")),
            "login_notice_phone" => intval(configuration("allow_cancel_sms_captcha")),
        ...
        if ($data["type"] == "phone") {
            ...
            $validate->message([
                "account.require" => "Mobile number cannot be empty",
                "account.length" => "Phone length is 4-11 digits",
            ]);
