...
class UserAffiliateController extends CommonController
{
    ...
    public function affindex(\think\Request $request)
    {
        ...
        if ($aus["affiliate_enabled"] == 1) {
            ...
            if ($affiliate_type == 1) {
                $data1[] = [
                    "affiliate_name" => "推介收益",
                    "affiliate_des" => "推介的用户注册购买产品后返佣金额",
                    "affiliate_type" => "固定金额",
                    "affiliate_bates" => $data["prefix"] . sprintf("%.2f", $aus["affiliate_bates"]),
                ];
            } else {
                $data1[] = [
                    "affiliate_name" => "推介收益",
                    "affiliate_des" => "推介的用户注册购买产品后返佣金额",
                    "affiliate_type" => "百分比",
                    "affiliate_bates" => $aus["affiliate_bates"] . "%",
                ];
            }
        } else {
            ...
            if ($data["affiliate_enabled"]) {
                ...
                if ($affiliate_type == 1) {
                    $data1[] = [
                        ...
                        "affiliate_des" => "推介的用户注册购买产品后返佣金额",
                        "affiliate_type" => "固定金额",
                        "affiliate_bates" => $data["prefix"] . sprintf("%.2f", configuration("affiliate_bates")),
                    ];
                } else {
                    $data1[] = [
                        "affiliate_name" => "推介收益",
                        "affiliate_des" => "推介的用户注册购买产品后返佣金额",
                        "affiliate_type" => "百分比",
                        "affiliate_bates" => configuration("affiliate_bates") . "%",
                    ];
                }
            }
        }
        if ($aus["affiliate_is_renew"] == 1) {
            ...
            if ($affiliate_type == 1) {
                $data1[] = [
                    "affiliate_name" => "续费收益",
                    "affiliate_des" => "推介的用户产品续费后返佣金额",
                    "affiliate_type" => "固定金额",
                    "affiliate_bates" => $data["prefix"] . sprintf("%.2f", $aus["affiliate_renew"]),
                ];
            } else {
                $data1[] = [
                    "affiliate_name" => "续费收益",
                    "affiliate_des" => "推介的用户产品续费后返佣金额",
                    "affiliate_type" => "百分比",
                    "affiliate_bates" => $aus["affiliate_renew"] . "%",
                ];
            }
        } else {
            ...
            if ($data["affiliate_is_renew"]) {
                ...
                if ($affiliate_type == 1) {
                    $data1[] = [
                        ...
                        "affiliate_des" => "推介的用户产品续费后返佣金额",
                        "affiliate_type" => "固定金额",
                        "affiliate_bates" => $data["prefix"] . sprintf("%.2f", configuration("affiliate_renew")),
                    ];
                } else {
                    $data1[] = [
                        "affiliate_name" => "续费收益",
                        "affiliate_des" => "推介的用户产品续费后返佣金额",
                        "affiliate_type" => "百分比",
                        "affiliate_bates" => configuration("affiliate_renew") . "%",
                    ];
                }
            }
        }
        if ($aus["affiliate_is_reorder"] == 1) {
            ...
            if ($affiliate_type == 1) {
                $data1[] = [
                    "affiliate_name" => "二次购买",
                    "affiliate_des" => "推介的用户二次购买产品后返佣金额",
                    "affiliate_type" => "固定金额",
                    "affiliate_bates" => $data["prefix"] . sprintf("%.2f", $aus["affiliate_reorder"]),
                ];
            } else {
                $data1[] = [
                    "affiliate_name" => "二次购买",
                    "affiliate_des" => "推介的用户二次购买产品后返佣金额",
                    "affiliate_type" => "百分比",
                    "affiliate_bates" => $aus["affiliate_reorder"] . "%",
                ];
            }
        } else {
            ...
            if ($data["affiliate_is_reorder"]) {
                ...
                if ($affiliate_type == 1) {
                    $data1[] = [
                        ...
                        "affiliate_des" => "推介的用户二次购买产品后返佣金额",
                        "affiliate_type" => "固定金额",
                        "affiliate_bates" => $data["prefix"] . sprintf("%.2f", configuration("affiliate_reorder")),
                    ];
                } else {
                    $data1[] = [
                        "affiliate_name" => "二次购买",
                        "affiliate_des" => "推介的用户二次购买产品后返佣金额",
                        "affiliate_type" => "百分比",
                        "affiliate_bates" => configuration("affiliate_reorder") . "%",
                    ];
                }
            }
        }
    ...
    public function withdrawrecord(\think\Request $request)
    {
        ...
        $rows = \think\Db::name("affiliates_withdraw")
            ->alias("a")
            ->field("a.*,u.user_nickname,cu.suffix")
    ...
    public function useraffilist()
    {
        ...
        $rows = \think\Db::name("affiliates_user")
            ...
            ->field("c.id,c.create_time,c.username,c.companyname,c.lastlogin,c.email,c.phonenumber")
