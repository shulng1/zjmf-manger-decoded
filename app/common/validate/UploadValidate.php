...
class UploadValidate extends \think\Validate
{
    protected $rule = [
        "file" =>
            "require|fileExt:png,jpg,jpeg,gif,doc,docx,key,numbers,pages,pdf,ppt,pptx,txt,rtf,vcf,xls,xlsx|fileMime:image/jpeg,image/png,image/gif|fileSize:67108864",
